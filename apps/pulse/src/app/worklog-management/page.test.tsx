...
jest.mock('@/components/features/timesheet/bulk-delete-action', () => ({
  BulkDeleteAction: ({
    selectedCount,
    onBulkDelete,
    onClearSelection,
...
jest.mock('@workspace/ui/components/alert', () => ({
  Alert: ({
    children,
    ...props
  }: {
...
jest.mock('@workspace/ui/components/native-select', () => ({
  NativeSelect: ({
    children,
    onChange,
    ...props
...
jest.mock('@workspace/ui/components/pagination', () => ({
